...
public class CDino {
	...
	public static void main(String[] args) {
		...
		/*
		 * ADinasaur[] dino = new ADinasaur[7]; dino[0] = triceRatops; dino[1] =
		 * stegoSaurus; dino[2] = scelidoSaurus; dino[3] = protoceRatops; dino[4] =
		 * brachioSaurus; dino[5] = tyrannoSaurus; dino[6] = velociRaptor;
		 */
